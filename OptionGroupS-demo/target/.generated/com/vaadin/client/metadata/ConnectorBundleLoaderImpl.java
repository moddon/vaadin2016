      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setSuperClass(com.motasim.optiongroups.client.OptionGroupSState.class, com.vaadin.shared.ui.select.AbstractSelectState.class);
            ...
            store.setClass("com.motasim.optiongroups.OptionGroupS", com.motasim.optiongroups.client.OptionGroupSConnector.class);
            ...
            store.setConstructor(com.motasim.optiongroups.client.OptionGroupSConnector.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.motasim.optiongroups.client.OptionGroupSConnector.class);
              }
            });
            store.setConstructor(com.motasim.optiongroups.client.OptionGroupSState.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.motasim.optiongroups.client.OptionGroupSState.class);
              }
            });
            store.setConstructor(com.motasim.optiongroups.client.OptionGroupSWidget.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.motasim.optiongroups.client.OptionGroupSWidget.class);
              }
            });
          ...
          private void load1() {
            ...
            store.setReturnType(com.motasim.optiongroups.client.OptionGroupSConnector.class, "getState", new Type(com.motasim.optiongroups.client.OptionGroupSState.class));
            store.setReturnType(com.motasim.optiongroups.client.OptionGroupSConnector.class, "getWidget", new Type(com.motasim.optiongroups.client.OptionGroupSWidget.class));
          ...
          private void load2() {
            ...
            store.setParamTypes(com.motasim.optiongroups.client.OptionGroupSServerRpc.class, "selected", new Type[] {new Type(java.lang.Integer.class), });
            ...
            store.setProxyHandler(com.motasim.optiongroups.client.OptionGroupSServerRpc.class, new com.vaadin.client.metadata.ProxyHandler() {
              public Object createProxy(final com.vaadin.client.metadata.InvokationHandler handler) {
                return new com.motasim.optiongroups.client.OptionGroupSServerRpc() {
                  public void selected(int p0) {
                    handler.invoke(this, com.vaadin.client.metadata.TypeData.getType(com.motasim.optiongroups.client.OptionGroupSServerRpc.class).getMethod("selected"), new Object [] {p0, });
                  }
                };
              }
            });
          ...
          private void load4() {
            ...
            store.setPropertyType(com.motasim.optiongroups.client.OptionGroupSState.class, "latestChosen", new Type(java.lang.Integer.class));
            ...
            store.setPropertyType(com.motasim.optiongroups.client.OptionGroupSState.class, "options", new Type(java.lang.String[].class));
          ...
          private void load5() {
            ...
            store.addOnStateChangeMethod(com.motasim.optiongroups.client.OptionGroupSConnector.class, new com.vaadin.client.metadata.OnStateChangeMethod(com.vaadin.client.ui.AbstractComponentConnector.class, "handleContextClickListenerChange", new String[] {"registeredEventListeners", }));
          ...
          private native void loadNativeJs0(com.vaadin.client.metadata.TypeDataStore store) /*-{
            ...
            var data = {
              setter: function(bean, value) {
                bean.@com.motasim.optiongroups.client.OptionGroupSState::latestChosen = value.@java.lang.Integer::intValue()();
              },
              getter: function(bean) {
                return @java.lang.Integer::valueOf(I)(bean.@com.motasim.optiongroups.client.OptionGroupSState::latestChosen);
              }
            };
            store.@com.vaadin.client.metadata.TypeDataStore::setPropertyData(Ljava/lang/Class;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(@com.motasim.optiongroups.client.OptionGroupSState::class, 'latestChosen', data);
          ...
          private native void loadNativeJs1(com.vaadin.client.metadata.TypeDataStore store) /*-{
            ...
            var data = {
              setter: function(bean, value) {
                bean.@com.motasim.optiongroups.client.OptionGroupSState::options = value;
              },
              getter: function(bean) {
                return bean.@com.motasim.optiongroups.client.OptionGroupSState::options;
              }
            };
            store.@com.vaadin.client.metadata.TypeDataStore::setPropertyData(Ljava/lang/Class;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(@com.motasim.optiongroups.client.OptionGroupSState::class, 'options', data);
